          ...
          <div class="col-lg-7">
            <div class="banner_content d-flex flex-md-row flex-column">
              <div class="banner-left text-md-right">
                <h1 class="text-uppercase">Foire aux questions</h1>
              </div>
              <div class="banner-right position-relative">
                <p>
                  Les questions les plus posées sont répondues.
                </p>
                <span class="main_btn mt-4 mt-md-0" href="#">
                  <a href="index.html" class="text-white">Accueil</a>
                  <i class="fa fa-arrow-right mx-2"></i>
                  <a href="services.html" class="text-white">FAQ</a>
                </span>
              </div>
            </div>
          </div>
 ...
 <section class="feature-area section_gap_top">
        ...
        <div class="accordion" id="accordionExample">
            <div class="card">
                ...
                <h2 class="mb-0">
                    ...
                    Comment procéder à une importation avec Logis ? 
                    </button>
                </h2>
                </div>
    ...
    <div class="card-header" id="headingTwo">
      <h2 class="mb-0">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          Les différents services de logistique offerts par Logis ?
        </button>
      </h2>
    </div>
    ...
    <div class="card-header" id="headingThree">
      <h2 class="mb-0">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
          Quel est la durée de l'importation d'une cargaison ?
        </button>
      </h2>
    </div>
  ...
  <div class="card">
    <div class="card-header" id="headingFour">
      <h2 class="mb-0">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
          Quels documents sont importants pour importer une marchandise ?
        </button>
      </h2>
    </div>
